/*
The script runs into issue if used with a user account which doesn’t have lots of public repo’s available.
“Unhandled rejection TypeError: Cannot read property ‘split’ of undefined”
Either add more repo’s (laborious), or change the initial URI in getUser() to point at a use with lots of repo’s e.g.
“uri”: “https://api.github.com/users/dcramer",
*/
...
var github = {
  ...
  getUser: function() {
    return request({
      "method":"GET",
      //"uri": "https://api.github.com/users/clearlydefined",
      "uri": "https://api.github.com/users/dcramer",
      "json": true,
      "headers": {
